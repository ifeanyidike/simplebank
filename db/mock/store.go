...
// Source: github.com/ifeanyidike/simple_bank/db/sqlc (interfaces: Store)
...
// ListEnties mocks base method.
func (m *MockStore) ListEnties(arg0 context.Context, arg1 db.ListEntiesParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEnties", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListEnties indicates an expected call of ListEnties.
func (mr *MockStoreMockRecorder) ListEnties(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEnties", reflect.TypeOf((*MockStore)(nil).ListEnties), arg0, arg1)
}
